...
flowchart TD
    ...
    F --> G
    G --> H{"Structural agent (thread 1)<br/>information_hierarchy, cta_cadence<br/>loops on create_inline_comment"}
    G --> I{"Line-Editor agent (thread 2)<br/>tone_drift, readability +<br/>the 3 deterministic categories<br/>loops on create_suggestion /<br/>create_inline_comment"}
