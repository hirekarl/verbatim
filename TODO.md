...
- [x] **Christina**: final coverage pass on `tests/test_prompts_structural.py`. *(Already at 100% coverage — 17 statements, 0 missing, all branches covered. No gaps to fill.)*
...
- [x] ~~**Christina** (proposed): revisit #69 golden-edge category-tiebreaker bug.~~ *(#69 closed — PR #72 improved Claude Sonnet to ~67% on GOLDEN, accepted as good enough for demo. Further refinement deferred post-demo.)*
